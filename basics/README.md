...
# 0. Where am I?
The ```0-current_working_directory``` script displays the absolute path of the current directory upon executio.
...
* The ```ls``` (LiSt) command lists the files and directories contained in the working directory.
